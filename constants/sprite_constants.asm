...
; SpriteSheetPointerTable indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_MEW                       ; $70
	const SPRITE_MEWTWO                    ; $71
	const SPRITE_MEOWTH                    ; $72
	const SPRITE_MOLTRES                   ; $73
	const SPRITE_NIDORANF                  ; $74
	const SPRITE_OFFICER_JENNY             ; $75
	const SPRITE_PIDGEOT                   ; $76
	const SPRITE_PIDGEY                    ; $77
	const SPRITE_PIKACHU                   ; $78
	const SPRITE_POLIWRATH                 ; $79
	const SPRITE_PSYDUCK                   ; $7a
	const SPRITE_SLOWPOKE                  ; $7b
	const SPRITE_SPEAROW                   ; $7c
	const SPRITE_ZAPDOS                    ; $7d
	; without a walk animation:
	const SPRITE_BULBASAUR                 ; $7e
	const SPRITE_DRAGONAIR                 ; $7f
	const SPRITE_DR_MASON                  ; $80
	const SPRITE_FLAREON                   ; $81
	const SPRITE_JOLTEON                   ; $82
	const SPRITE_MACHAMP                   ; $83
	const SPRITE_NIDOKING                  ; $84
	const SPRITE_NIDORANM                  ; $85
	const SPRITE_NIDORINO                  ; $86
	const SPRITE_NURSE_JOY                 ; $87
	const SPRITE_SLOWBRO                   ; $88
	; sitting sprites:
	const SPRITE_NURSE_JOY_SITTING         ; $89
	const SPRITE_OFFICER_JENNY_SITTING     ; $8a
	; PureRGB Tweaked: end of new overworld sprites.
DEF FIRST_STILL_SPRITE EQU const_value
	const SPRITE_POKE_BALL                 ; $8b
	const SPRITE_FOSSIL                    ; $8c
	const SPRITE_BOULDER                   ; $8d
	const SPRITE_PAPER                     ; $8e
	const SPRITE_POKEDEX                   ; $8f
	const SPRITE_CLIPBOARD                 ; $90
	const SPRITE_SNORLAX                   ; $91
	const SPRITE_OLD_AMBER                 ; $92
	const SPRITE_GAMBLER_ASLEEP            ; $93
	const SPRITE_MONSTER2_STILL            ; $94
	const SPRITE_POKE_BALL2                ; $95
	const SPRITE_DARK_CHANNELER            ; $96
	const SPRITE_BOOMBOX                   ; $97
	const SPRITE_NOTHING_STILL             ; $98
	const SPRITE_SCUBA_DIVER               ; $99
	const SPRITE_CAMERA                    ; $9a
	const SPRITE_SHADOW                    ; $9b
	const SPRITE_QUADRUPED                 ; $9c
	; PureRGB Tweaked : added unique (but static) overworld sprites
	const SPRITE_ABRA                      ; $9d
	const SPRITE_WIGGLYTUFF                ; $9e
