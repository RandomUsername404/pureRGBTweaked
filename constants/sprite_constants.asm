...
; SpriteSheetPointerTable indexes (see data/sprites/sprites.asm)
	...
	; PureRGB Tweaked: added unique overworld sprites
	; with a walk animation:
	const SPRITE_ARCANINE                  ; $61
	const SPRITE_ARTICUNO                  ; $62
	const SPRITE_CHANSEY                   ; $63
	const SPRITE_CLOYSTER                  ; $64
	const SPRITE_CUBONE                    ; $65
	const SPRITE_DODUO                     ; $66
	const SPRITE_FARFETCHD                 ; $67
	const SPRITE_FEAROW                    ; $68
	const SPRITE_JIGGLYPUFF                ; $69
	const SPRITE_KANGASKHAN                ; $6a
	const SPRITE_LAPRAS                    ; $6b
	const SPRITE_MACHOKE                   ; $6c
	const SPRITE_MACHOP                    ; $6d
	const SPRITE_MAGMAR_SWIMMING           ; $6e
	const SPRITE_MANKEY                    ; $6f
	const SPRITE_MAROWAK_SPIRIT            ; $70
	const SPRITE_MEW                       ; $71
	const SPRITE_MEWTWO                    ; $72
	const SPRITE_MEOWTH                    ; $73
	const SPRITE_MOLTRES                   ; $74
	const SPRITE_NIDORANF                  ; $75
	const SPRITE_OFFICER_JENNY             ; $76
	const SPRITE_PIDGEOT                   ; $77
	const SPRITE_PIDGEY                    ; $78
	const SPRITE_PIKACHU                   ; $79
	const SPRITE_POLIWRATH                 ; $7a
	const SPRITE_PSYDUCK                   ; $7b
	const SPRITE_SLOWPOKE                  ; $7d
	const SPRITE_SPEAROW                   ; $7d
	const SPRITE_ZAPDOS                    ; $7e
	; without a walk animation:
	const SPRITE_BULBASAUR                 ; $7f
	const SPRITE_DRAGONAIR                 ; $80
	const SPRITE_DR_MASON                  ; $81
	const SPRITE_FLAREON                   ; $82
	const SPRITE_JOLTEON                   ; $83
	const SPRITE_MACHAMP                   ; $84
	const SPRITE_NIDOKING                  ; $85
	const SPRITE_NIDORANM                  ; $86
	const SPRITE_NIDORINO                  ; $87
	const SPRITE_NURSE_JOY                 ; $88
	const SPRITE_SLOWBRO                   ; $89
	; sitting sprites:
	const SPRITE_NURSE_JOY_SITTING         ; $8a
	const SPRITE_OFFICER_JENNY_SITTING     ; $8b
	; PureRGB Tweaked: end of new overworld sprites.
DEF FIRST_STILL_SPRITE EQU const_value
	const SPRITE_POKE_BALL                 ; $8c
	const SPRITE_FOSSIL                    ; $8d
	const SPRITE_BOULDER                   ; $8e
	const SPRITE_PAPER                     ; $8f
	const SPRITE_POKEDEX                   ; $90
	const SPRITE_CLIPBOARD                 ; $91
	const SPRITE_SNORLAX                   ; $92
	const SPRITE_OLD_AMBER                 ; $93
	const SPRITE_GAMBLER_ASLEEP            ; $94
	const SPRITE_MONSTER2_STILL            ; $95
	const SPRITE_POKE_BALL2                ; $96
	const SPRITE_DARK_CHANNELER            ; $97
	const SPRITE_BOOMBOX                   ; $98
	const SPRITE_NOTHING_STILL             ; $99
	const SPRITE_SCUBA_DIVER               ; $9a
	const SPRITE_CAMERA                    ; $9b
	const SPRITE_SHADOW                    ; $9c
	const SPRITE_QUADRUPED                 ; $9e
	; PureRGB Tweaked : added unique (but static) overworld sprites
	const SPRITE_ABRA                      ; $9e
	const SPRITE_WIGGLYTUFF                ; $9f
