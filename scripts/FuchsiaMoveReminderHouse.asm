FuchsiaMoveReminderHouse_Script:
	jp EnableAutoTextBoxDrawing

FuchsiaMoveReminderHouse_TextPointers:
	def_text_pointers
	dw_const MoveReminderText, TEXT_FUCHSIAMOVEREMINDERHOUSE_REMINDER
	dw_const MoveDeleterText,  TEXT_FUCHSIAMOVEREMINDERHOUSE_DELETER
