...
BlkPacket_PureTitlescreen:
	ATTR_BLK 4
	ATTR_BLK_DATA %011, 0,0,0, 00,00, 19,08 ; pokemon logo: pal 0
	ATTR_BLK_DATA %010, 1,1,0, 00,09, 19,09 ; version text: pal 1
...
; RGBTweaked: custom colors for the Japanese Pokémon logo when the TWK titlescreen is selected (SGB)
IF DEF(_RED)
PalPacket_PureTitlescreen_SGB:    PAL_SET PAL_REALLY_REDMON, PAL_LOGO1, PAL_REDMON, PAL_MEWMON
ENDC
IF DEF(_BLUE)
PalPacket_PureTitlescreen_SGB:    PAL_SET PAL_BLUEMON, PAL_LOGO1, PAL_CYANMON, PAL_MEWMON
ENDC
IF DEF(_GREEN)
PalPacket_PureTitlescreen_SGB:    PAL_SET PAL_GREENMON, PAL_LOGO1, PAL_GREENMON, PAL_MEWMON
ENDC
; RGBTweaked: custom colors for the Japanese Pokémon logo when the TWK titlescreen is selected (GBC)
IF DEF(_RED)
PalPacket_PureTitlescreen_GBC:    PAL_SET PAL_REALLY_REDMON, PAL_LOGO1, PAL_MEWMON, PAL_MEWMON
ENDC
IF DEF(_BLUE)
PalPacket_PureTitlescreen_GBC:    PAL_SET PAL_BLUEMON, PAL_LOGO1, PAL_MEWMON, PAL_MEWMON
ENDC
IF DEF(_GREEN)
PalPacket_PureTitlescreen_GBC:    PAL_SET PAL_GREENMON, PAL_LOGO1, PAL_MEWMON, PAL_MEWMON
ENDC
;;;;;;;;;;;;;;
