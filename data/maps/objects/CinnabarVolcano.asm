; PureRGBnote: CHANGED: many maps had their objects (items, NPCs, maps) modified for new content
	...
	const_export CINNABAR_VOLCANO_SURFING_RHYDON_ENTRANCE
...
CinnabarVolcano_Object:
	...
	object_event 21, 13, SPRITE_ARCANINE, STAY, RIGHT, 3
	object_event  4, 14, SPRITE_MOLTRES, STAY, DOWN, TEXT_CINNABAR_VOLCANO_MOLTRES, MOLTRES, 50 ; moltres
	...
	object_event 48, 65, SPRITE_MAGMAR_SWIMMING, STAY, UP, TEXT_CINNABAR_VOLCANO_BOSS_MAGMAR
	object_event 23,  4, SPRITE_MONSTER_SWIMMING, STAY, NONE, TEXT_CINNABAR_VOLCANO_SURFING_RHYDON_ENTRANCE
