	...
	const_export CELADONHOTEL_GRAMPS
...
CeladonHotel_Object:
	...
	object_event  8,  5, SPRITE_SUPER_NERD, WALK, LEFT_RIGHT, TEXT_CELADONHOTEL_SUPER_NERD
	object_event  5,  3, SPRITE_SILPH_WORKER_M, STAY, NONE, TEXT_CELADONHOTEL_LAPRAS_GUY
	object_event  9,  1, SPRITE_GRAMPS, STAY, DOWN, TEXT_CELADONHOTEL_GRAMPS
