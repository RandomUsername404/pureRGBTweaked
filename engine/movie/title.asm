...
_DisplayTitleScreen::
	...
	call FarCopyData2
	; RGBTweaked: load alternative logo if TWK title screen is enabled (Pure path)
	call IsPureTitleScreenEnabled
	jr nz, .loadAltLogoFirst
	ld hl, PokemonLogoGraphics
	jr .gotFirst
.loadAltLogoFirst
	ld hl, PokemonLogoJPGraphics
.gotFirst
	ld de, vTitleLogo
	ld bc, $60 tiles
	call IsPureTitleScreenEnabled
	...
	jr .doFirstChunk
.pureBank1
	ld a, BANK(PokemonLogoJPGraphics)
.doFirstChunk
	call FarCopyData2          ; first chunk

	call IsPureTitleScreenEnabled
	jr nz, .loadAltLogoSecond
	ld hl, PokemonLogoGraphics tile $60
	jr .gotSecond
.loadAltLogoSecond
	ld hl, PokemonLogoJPGraphics tile $60
.gotSecond
	ld de, vTitleLogo2
	ld bc, $10 tiles
	call IsPureTitleScreenEnabled
...
; place tiles for title screen copyright  
	call IsPureTitleScreenEnabled
	jr nz, .next                    ; RGBTweaked: skip copyright if Pure titlescreen is enabled  
...
;RGBTweaked: kept for farcall compatibility with diploma.asm
