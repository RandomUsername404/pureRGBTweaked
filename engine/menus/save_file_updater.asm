...
AddedHideShowFlags:
	...
	db TOGGLE_CERULEAN_BULBASAUR            ; NEW RGB Tweaked
	db -1
...
.dontHideCeladonLaprasGuy
	CheckEvent EVENT_GOT_BULBASAUR_IN_CERULEAN ; RGBTweaked: added check so Bulbasaur can appear on imported saves
