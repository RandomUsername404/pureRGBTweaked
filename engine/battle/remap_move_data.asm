...
RemappableMoves::
	...
	db COMET_PUNCH, HITMONCHAN, 30, 0
	db THUNDERPUNCH, ELECTABUZZ, 100, 0
	db FIRE_PUNCH, MAGMAR, 100, 0
	db ICE_PUNCH, JYNX, 100, 0
	db HYPNOSIS, HYPNO, -1, 85 percent
	db DRAGON_RAGE, DRAGONITE, 100, 0
	db WATERFALL, SEAKING, 140, 0
	db DIZZY_PUNCH, KANGASKHAN, 130, 0
	db LICK, LICKITUNG, 75, 0
